...
void RenderablePolyVoxEntityItem::recomputeMesh() {
    ...
    QtConcurrent::run([entity, voxelSurfaceStyle] {
        ...
        auto indexBuffer = std::make_shared<gpu::Buffer>(gpu::Buffer::UsageFlagBits::IndexBuffer, vecIndices.size() * sizeof(uint32_t),
        ...
        auto vertexBuffer = std::make_shared<gpu::Buffer>(gpu::Buffer::UsageFlagBits::VertexBuffer, vecVertices.size() * sizeof(PolyVox::PositionMaterialNormal),
