...
QScriptValue ModelScriptingInterface::appendMeshes(MeshProxyList in) {
    ...
    gpu::Buffer* combinedVertexBuffer = new gpu::Buffer(gpu::Buffer::UsageFlagBits::VertexBuffer, combinedVertexSize, combinedVertexData.get());
    ...
    gpu::Buffer* combinedColorsBuffer = new gpu::Buffer(gpu::Buffer::UsageFlagBits::VertexBuffer, combinedColorSize, combinedColorData.get());
    ...
    gpu::Buffer* combinedNormalsBuffer = new gpu::Buffer(gpu::Buffer::UsageFlagBits::VertexBuffer, combinedNormalSize, combinedNormalData.get());
    ...
    gpu::Buffer* combinedIndexesBuffer = new gpu::Buffer(gpu::Buffer::UsageFlagBits::IndexBuffer, combinedIndexSize, combinedIndexData.get());
    ...
    result->setPartBuffer(gpu::BufferView(new gpu::Buffer(gpu::Buffer::UsageFlagBits::IndirectBuffer, parts.size() * sizeof(graphics::Mesh::Part),
...
QScriptValue ModelScriptingInterface::newMesh(const QVector<glm::vec3>& vertices,
    ...
    // vertices
    auto vertexBuffer = std::make_shared<gpu::Buffer>(gpu::Buffer::UsageFlagBits::VertexBuffer, vertices.size() * sizeof(glm::vec3), (gpu::Byte*)vertices.data());
    ...
    if (vertices.size() == normals.size()) {
        // normals
        auto normalBuffer = std::make_shared<gpu::Buffer>(gpu::Buffer::UsageFlagBits::VertexBuffer, normals.size() * sizeof(glm::vec3), (gpu::Byte*)normals.data());
    ...
    auto indexBuffer = std::make_shared<gpu::Buffer>(gpu::Buffer::UsageFlagBits::IndexBuffer, indexBufferSize, (gpu::Byte*)indexData);
    ...
    parts.emplace_back(graphics::Mesh::Part((graphics::Index)0, // startIndex
                                         ...
                                         (graphics::Index)0, // baseVertex
                                         graphics::Mesh::TRIANGLES)); // topology
    mesh->setPartBuffer(gpu::BufferView(new gpu::Buffer(gpu::Buffer::UsageFlagBits::IndirectBuffer, parts.size() * sizeof(graphics::Mesh::Part),
                                                        (gpu::Byte*) parts.data()), gpu::Element::PART_DRAWCALL));
