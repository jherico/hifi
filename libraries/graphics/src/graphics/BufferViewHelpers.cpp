...
template <typename T>
gpu::BufferView newFromVector(const gpu::Buffer::UsageFlags& usage, const QVector<T>& elements, const gpu::Element& elementType) {
...
template <typename T>
gpu::BufferView bufferViewFromVector(const gpu::Buffer::UsageFlags& usage, const QVector<T>& elements, const gpu::Element& elementType) {
    auto vertexBuffer = std::make_shared<gpu::Buffer>(usage, elements.size() * sizeof(T), (gpu::Byte*)elements.data());
    return { vertexBuffer, 0, vertexBuffer->getSize(),sizeof(T), elementType };
}
template<> gpu::BufferView newFromVector<unsigned int>(const gpu::Buffer::UsageFlags& usage, const QVector<unsigned int>& elements, const gpu::Element& elementType) { return bufferViewFromVector(usage, elements, elementType); }
template<> gpu::BufferView newFromVector<glm::vec2>(const gpu::Buffer::UsageFlags& usage, const QVector<glm::vec2>& elements, const gpu::Element& elementType) { return bufferViewFromVector(usage, elements, elementType); }
template<> gpu::BufferView newFromVector<glm::vec3>(const gpu::Buffer::UsageFlags& usage, const QVector<glm::vec3>& elements, const gpu::Element& elementType) { return bufferViewFromVector(usage, elements, elementType); }
template<> gpu::BufferView newFromVector<glm::vec4>(const gpu::Buffer::UsageFlags& usage, const QVector<glm::vec4>& elements, const gpu::Element& elementType) { return bufferViewFromVector(usage, elements, elementType); }
template<> gpu::BufferView newFromVector<graphics::Mesh::Part>(const gpu::Buffer::UsageFlags& usage, const QVector<graphics::Mesh::Part>& elements, const gpu::Element& elementType) { return bufferViewFromVector(usage, elements, elementType); }
...
template<> gpu::BufferView newFromVector<QVariant>(const gpu::Buffer::UsageFlags& usage, const QVector<QVariant>& _elements, const gpu::Element& elementType) {
