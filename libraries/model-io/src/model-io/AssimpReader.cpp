//
//  Created by Bradley Austin Davis on 2016/03/06.
...
bool Import3DFromFile(const QString& path) {
    static Assimp::Importer importer;
    auto scene = importer.ReadFile(path.toLocal8Bit().data(), aiProcessPreset_TargetRealtime_MaxQuality);
