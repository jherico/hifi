...
LightingModel::LightingModel() {
    ...
    _parametersBuffer = gpu::BufferView(std::make_shared<gpu::Buffer>(gpu::Buffer::UsageFlagBits::UniformBuffer, sizeof(Parameters), (const gpu::Byte*) &parameters, sizeof(Parameters)));
}
