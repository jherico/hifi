...
DeferredFrameTransform::DeferredFrameTransform() {
    ...
    _frameTransformBuffer = gpu::BufferView(std::make_shared<gpu::Buffer>(gpu::Buffer::UsageFlagBits::UniformBuffer, sizeof(FrameTransform), (const gpu::Byte*) &frameTransform));
}
