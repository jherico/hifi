...
public:
    ...
    void trash(const vks::Buffer& buffer);
#if 0
    // Draw Stage
...
protected:
    ...
    const vk::PhysicalDeviceProperties& _physicalDeviceProperties{ _context.deviceProperties };
    const vk::PhysicalDeviceFeatures& _physicalDeviceFeatures{ _context.deviceFeatures };
    const vk::PhysicalDeviceMemoryProperties& _physicalDeviceMemoryProperties{ _context.deviceMemoryProperties };
