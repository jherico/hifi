...
void Cube3DOverlay::setProperties(const QJSValue& properties) {
    Volume3DOverlay::setProperties(properties);

    QJSValue borderSize = properties.property("borderSize");
...
QJSValue Cube3DOverlay::getProperty(const QString& property) {
