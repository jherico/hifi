...
ApplicationWindow {
    ...
    property bool platformIsMac: false
        ...
        id: navigationBar
            RowLayout {
                ...
                TextField {
                    ...
                    onAccepted: currentWebView.url = text //utils.fromUserInput(text)
                }
                ToolButton {
        ...
        Component {
            ...
            WebEngineView {
                ...
                onLinkHovered: function(hoveredUrl) {
                    console.warn("Hovered URL " + hoveredUrl)
                    if (hoveredUrl == "")
                ...
                onRegisterProtocolHandlerRequested: function(request) {
                    console.warn("accepting registerProtocolHandler request for "
                ...
                onFeaturePermissionRequested: function(securityOrigin, feature) {
                    console.warn("Requesting feature " +  feature + " from origin " + securityOrigin)
    ...
    WebEngineView {
        ...
        onFeaturePermissionRequested: function(securityOrigin, feature) {
            console.log("Requesting feature " +  feature + " from origin " + securityOrigin)
            grantFeaturePermission(securityOrigin, feature, true)
        }
