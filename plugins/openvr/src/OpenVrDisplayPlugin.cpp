...
void OpenVrDisplayPlugin::hmdPresent() {
    ...
    static const vr::EVRSubmitFlags SUBMIT_FLAGS = vr::Submit_TextureWithPose;
    ...
    vr::VRCompositor()->Submit(vr::Eye_Left, &vrTexture, &OPENVR_TEXTURE_BOUNDS_LEFT, SUBMIT_FLAGS);
    vr::VRCompositor()->Submit(vr::Eye_Right, &vrTexture, &OPENVR_TEXTURE_BOUNDS_RIGHT, SUBMIT_FLAGS);
